...
"Ingenierías" : [
    ...
    function startGame(category) {
        ...
        currentQuestions = shuffle([...questions[category]]).slice(0, 10);
    ...
    function endGame() {
        ...
        const msg = score >= 6 ? `¡Completaste ${currentCategory} con ${score} respuestas correctas!` : `Terminaste ${currentCategory} con ${score} respuestas correctas. ¡Sigue practicando!`;
